...
public class DeviceReconciler extends Reconciler<Boolean, DeviceReconciler.Observed> {
    ...
    public DeviceReconciler(Logger logger, DevicePort port, BooleanSupplier scanIsOff, ResetBudget resetBudget,
        ...
        this(logger, port, scanIsOff, resetBudget, requestAdapterReset, clock, DeviceActorListener.NOOP);
    }

    /**
     * @param actorListener observes control-plane transitions for metrics; purely passive, and
     *            {@link DeviceActorListener#NOOP} when nothing is observing.
     */
    public DeviceReconciler(Logger logger, DevicePort port, BooleanSupplier scanIsOff, ResetBudget resetBudget,
            Runnable requestAdapterReset, Clock clock, DeviceActorListener actorListener) {
